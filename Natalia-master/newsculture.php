...
<h4 class="alert alert-info">Культура</h1>
	<?php
...
?>
	<div class="pl-5">
<?php $news = mysqli_query($connection, "SELECT * FROM `culture`");
				
				
				while ($row = $news->fetch_assoc()){
					echo "<section><h5><a href=\"culture.php?id=".$row['id']."\">".$row['title']."</a></h5><br /><p>".mb_substr($row['text'],0,250)."<p class=\"font-italic\"><a href=\"culture.php?id=".$row['id']."\">...читать далее
					</a></p></section>";
				}
			?>
