...
<h4 class="alert alert-info">Экономика</h1>
	<?php
...
<?php $news = mysqli_query($connection, "SELECT * FROM `economics`");
				...
				while ($row = $news->fetch_assoc()){
					echo "<section><h5><a href=\"economics.php?id=".$row['id']."\">".$row['title']."</a></h5><br /><p>".mb_substr($row['text'],0,250)."<p class=\"font-italic\"><a href=\"economics.php?id=".$row['id']."\">...читать далее
					</a></p></section>";
				}
			?>
